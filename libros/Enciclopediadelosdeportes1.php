...
$paginaEnciclopedia1 = new libros();
$paginaEnciclopedia1->setDescription("Enciclopedia de deportes");
$paginaEnciclopedia1->setPalabrasClave("Enciclopedia, deportes, futbol, balonmano, atletismo, ajedrez, karate, "
        . "beisbol, gimnasia");
$paginaEnciclopedia1->setTitulo("Enciclopedia de los deportes 1");
$paginaEnciclopedia1->setContenidos2("<article id=\"libros\"><p>Editorial:</p>&nbsp;Aura<br/><br/><blockquote>
...
$paginaEnciclopedia1->setEnlace("deportes.php");
$paginaEnciclopedia1->mostrar();