...
$paginaTusPlantas3 = new libros();
$paginaTusPlantas3->setDescription("fichero de plantas");
$paginaTusPlantas3->setPalabrasClave("jardineria, plantas, fichero");
$paginaTusPlantas3->setTitulo("Tus Plantas 1");
$paginaTusPlantas3->setEnlace("jardineria.php");
$paginaTusPlantas3->setContenidos2("<article id=\"libros\"><p>Autor:</p>&nbsp;<cite>Jorge Montoro</cite>
    <p>Desde <b>Do</b> a <b>He</b></p>
