...
$paginaEnciclopedia2 = new libros();
$paginaEnciclopedia2->setDescription("Enciclopedia de deportes");
$paginaEnciclopedia2->setPalabrasClave("Enciclopedia, deportes, futbol, balonmano, atletismo, ajedrez, karate, "
        . "beisbol, gimnasia");
$paginaEnciclopedia2->setTitulo("Enciclopedia de los deportes 2");
$paginaEnciclopedia2->setContenidos2("<article id=\"libros\"><p>Editorial:</p>&nbsp;Aura<br/><br/><blockquote>
...
$paginaEnciclopedia2->setEnlace("deportes.php");
$paginaEnciclopedia2->mostrar();