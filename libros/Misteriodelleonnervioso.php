...
$paginaLeon = new libros();
$paginaLeon->setDescription("Libro juvenil de misterio");
$paginaLeon->setPalabrasClave("Libro, juvenil, misterio, asaltos terrorificos, investigadores, Alfred Hitchcock");
$paginaLeon->setEnlace("novelas.php");
$paginaLeon->setTitulo("Misterio del león nervioso");
$paginaLeon->setContenidos2("<article id=\"libros\"><p>Autor:</p>&nbsp;<cite>Nick West</cite><p>Editorial:
